namespace CreateShortcut
{
    ...
    class AppStartCreateShortcut
    {
        ...
        {  
            ...
            {
                string helpMessage = CreateHelpMessage();
                Console.Error.WriteLine("insufficient arguments" + Environment.NewLine + helpMessage);
                Environment.Exit(1);
            } 
            ...
            CreateShortcut.ShellLink.CreateShortcut(
                shortcutPath, targetPathString, description, workingDirPathString);
        }
